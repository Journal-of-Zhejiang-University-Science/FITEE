...
%% article title
\title{Example of using \emph{FITEE} \LaTeX{} template \\ second line if necessary}
...
\shortauthor{Zhai and Hu}	% one author: only Zhai; two authors: Zhai and Hu; three authors: Zhai et al.
...
\dateinfo{Received mmm.\ dd, 2017;	Revision accepted mmm.\ dd, 2017;    Crosschecked mmm.\ dd, 2018}
...
\support{Project supported by the National Natural Science Foundation of China (No.~xxxxxxxx)} 
...
\orcid{Zi-yang ZHAI, http://orcid.org/xxxx-xxxx-xxxx-xxxx}	% corresponding author, or first author
\articleType{}
